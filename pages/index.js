        ...
        <div className="container mx-auto mb-10">
            ...
            <div
                ...
                <p className="m-5 mob:m-0 laptop:m-5 mob:mt-2 laptop:ml-0 ml-0 text-3xl mob:text-xl laptop:text-3xl w-3/5 mob:w-full laptop:w-3/5">
                    ...
                    <br />
                    We&#39;ve spent Christmas together, travelled together, partied together, and comforted each other. But, when things get difficult, we can always just lock our heads together, and you&#39;ll come out on top. Hopefully, you can <a href="https://www.dji.com/uk/pocket-2"><strong>capture some moments on your honeymoon and evolve from food blogger to world vlogger.</strong></a> Just let Aisha hold the camera, most shots don&#39;t look that great from 4.2ft.<br />
